...
This guide explains how to retrieve multiple accounts from your Tron wallet and use custom derivation paths.

## Retrieve Accounts by Index

You can access accounts derived from the default BIP-44 path (`m/44'/195'`) using [`wallet.getAccount()`](../api-reference.md#getaccount-index):
