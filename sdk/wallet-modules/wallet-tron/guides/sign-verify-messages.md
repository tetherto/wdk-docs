...
This guide explains how to sign arbitrary messages with an owned account and verify signatures using a read-only account. Tron uses secp256k1 cryptography for signing.
