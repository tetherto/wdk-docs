...
You can transfer TRX to a recipient address using [`account.sendTransaction()`](/sdk/wallet-modules/wallet-tron-gasfree/api-reference/#sendtransaction-tx):
...
You can get a fee estimate before sending using [`account.quoteSendTransaction()`](/sdk/wallet-modules/wallet-tron-gasfree/api-reference/#quotesendtransaction-tx):
...
You can retrieve current fee rates from the wallet manager using [`wallet.getFeeRates()`](/sdk/wallet-modules/wallet-tron-gasfree/api-reference/#getfeerates):
