...
{% hint style="info" %}
This guide outlines the conventions, architecture, and workflow for the `@tetherto/wdk-wallet-spark` repository. It is intended for developers contributing to the source code or AI agents working within the repository context.

Source: [`AGENTS.md`](https://github.com/tetherto/wdk-wallet-spark/blob/main/AGENTS.md)
{% endhint %}
...
- **Domain:** Spark Blockchain Wallet Management (Bitcoin Layer 2).
- **Key Library:** `@buildonspark/spark-sdk`.
- **Standards:** BIP-44 (m/44'/998').
- **Architecture:** Extends base wallet classes to support Spark transactions, Lightning Network, and Bitcoin Layer 1 bridge functionality.
- **Testing:** Integration tests often use Spark Regtest.
