...
{% hint style="info" %}
This guide outlines the conventions, architecture, and workflow for the `@tetherto/wdk-wallet-solana` repository. It is intended for developers contributing to the source code or AI agents working within the repository context.

Source: [`AGENTS.md`](https://github.com/tetherto/wdk-wallet-solana/blob/main/AGENTS.md)
{% endhint %}
