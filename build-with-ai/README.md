...
{% hint style="info" %}
**Looking to give your AI agent a wallet?** The WDK MCP Toolkit enables AI agents to send transactions, check balances, and interact with DeFi protocols programmatically. Documentation coming soon.
{% endhint %}
