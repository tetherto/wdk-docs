...
- **Sync and async failover**: The runtime retries synchronous throws and rejected promise-like results whose `then` property is a function.
...
<Callout type="info">
The returned proxy forwards property reads and method calls. It does not forward writes, enumeration, or property-descriptor operations to the active provider.
</Callout>
