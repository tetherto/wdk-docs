...
`@tetherto/wdk-asset-registry/assets/common-tokens` exports bundled token metadata. In `v1.0.0-beta.2`, the published list contains `USDT`, `USDT0`, and `XAUt` token records across supported chains.
