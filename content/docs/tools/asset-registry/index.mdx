...
<Callout type="info">
These pages reflect `@tetherto/wdk-asset-registry@1.0.0-beta.4`, including the compiled and cached Zod schemas in beta.3 and the corrected Berachain USD₮0 bundled metadata in beta.4.
</Callout>
