...
The current release is `1.0.0-beta.5`. Beta releases can change before the stable release. This release installs its built-in wallet modules as normal dependencies and does not require an npm lifecycle-script allowlist.
