...
Follow [Protocol Integration](/sdk/core-module/guides/protocol-integration) to choose an account and configure swaps or bridges.

<Callout type="warn">
Accounts derived by EVM wallet beta.19 cannot initialize Velora beta.8, USD₮0 bridge beta.10, or Aave beta.7 because those adapters do not accept the manager's shared ethers provider. The linked guide shows a direct-account setup with its policy, middleware, and cleanup requirements.
</Callout>
