...
<Cards>
<Card title="WDK CLI" href="/ai/wdk-cli">
Run a ready-made local wallet CLI, daemon, and MCP server for AI agents
</Card>
<Card title="MCP Toolkit" href="/ai/mcp-toolkit">
Build a custom MCP server that exposes WDK wallet tools
</Card>
...
<Callout type="info">
**Want to give AI agents wallet access?** Use [WDK CLI](/ai/wdk-cli/) for a ready-made local wallet CLI, daemon, and MCP server. Use the [MCP Toolkit](/ai/mcp-toolkit/) when you are building a custom MCP server in code.
</Callout>
