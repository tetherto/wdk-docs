...
<Callout type="info">
**Want to give AI agents wallet access?** Use [WDK CLI](/cli/) for a ready-made local wallet CLI, daemon, and MCP server. Use the [MCP Toolkit](/ai/mcp-toolkit/) when you are building a custom MCP server in code.
</Callout>
