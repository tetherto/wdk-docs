...
<Callout type="info">
If you want OpenClaw to call a ready-made local wallet daemon through MCP instead of loading a file-based skill, see [WDK CLI MCP setup](/ai/wdk-cli/mcp/).
</Callout>
...
![OpenClaw creating a multi-chain wallet using the WDK skill](/assets/openclaw-wallet-output.png)
...
- [WDK CLI MCP](/ai/wdk-cli/mcp/) - Configure OpenClaw with the bundled WDK CLI MCP server
