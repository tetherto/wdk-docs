...
<Callout type="warn">
`@semanticio/wdk-wallet-evm-x402-facilitator` is a community module developed and maintained independently by [Semantic Pay](https://www.semanticpay.io).

Tether and the WDK Team do not endorse or assume responsibility for its code, security, or maintenance. It is currently in beta. Test thoroughly before using in production.
