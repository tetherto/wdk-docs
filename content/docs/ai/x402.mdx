...
<Callout type="info">
**About the Semantic facilitator:** [Semantic](https://docs.semanticpay.io) operates a public USD₮0-enabled x402 facilitator at `https://x402.semanticpay.io`. This is a third-party service not operated, endorsed, or guaranteed by Tether.
...
- [EIP-3009 Specification](https://eips.ethereum.org/EIPS/eip-3009) - The authorization standard enabling gasless USD₮0 transfers
