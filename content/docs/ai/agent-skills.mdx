...
| **Bridges** | Cross-chain bridges with USD₮0 via LayerZero |
...
| [x402-usdt0](https://github.com/baghdadgherras/x402-usdt0) | Reference implementation of x402 on Plasma with USD₮0 |
