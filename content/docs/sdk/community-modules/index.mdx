...
| [@kenny_io/wdk-protocol-swidge-lifi](https://www.npmjs.com/package/@kenny_io/wdk-protocol-swidge-lifi) ([GitHub](https://github.com/kenny-io/wdk-lifi-swidge-protocol)) | Swidge Module | LI.FI swap and bridge routes through the WDK swidge interface | [Docs](/sdk/swidge-modules/swidge-lifi/) | [Kenny](https://github.com/kenny-io) |
