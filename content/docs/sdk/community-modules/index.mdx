...
| [wdk-protocol-fiat-peer](https://www.npmjs.com/package/wdk-protocol-fiat-peer) ([GitHub](https://github.com/zkp2p/wdk-protocol-fiat-peer)) | Fiat Module | Peer off-ramp for Base USDC with live fiat estimates and unsigned transaction preparation | [README](https://github.com/zkp2p/wdk-protocol-fiat-peer#readme) | [ZKP2P](https://github.com/zkp2p) |
