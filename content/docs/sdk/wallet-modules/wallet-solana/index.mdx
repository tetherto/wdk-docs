...
<Callout type="info">
These pages reflect `@tetherto/wdk-wallet-solana@1.0.0-beta.15`. This release re-exports shared WDK error classes and uses typed precondition, fee-cap, and validation failures; incomplete partial signatures retain the exact Solana error code `SOLANA_ERROR__TRANSACTION__SIGNATURES_MISSING`.
</Callout>
...
- **Signed Transaction Relay**: Quote and broadcast the exact `FullySignedTransaction` returned by `signTransaction()`
