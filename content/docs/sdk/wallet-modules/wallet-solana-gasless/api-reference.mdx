...
| `ConfigurationError` | Class | Error thrown when required paymaster configuration is missing or invalid. |
...
|--------|------|----------|-------------|
| `provider` | `string \| string[]` | Yes | Solana RPC endpoint or ordered failover list. |
...
Thrown when required configuration is missing or invalid, such as an empty paymaster failover list or missing required paymaster fields.
