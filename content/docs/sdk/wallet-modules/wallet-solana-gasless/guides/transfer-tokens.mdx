...
The merged module throws when the quoted transfer fee is greater than or equal to `transferMaxFee`.
...
- Token-2022 extensions and token-transfer memos are not supported by the merged module.
