...
<Callout type="warn">
On Ethereum mainnet, USD₮ requires an existing non-zero allowance to be reset to `0` before setting a new non-zero allowance. The module throws before sending when this rule would be violated.
</Callout>
