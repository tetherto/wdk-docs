...
*   **[Node.js](https://nodejs.org/)**: version 20.19.0 or higher. Since Wallet BTC beta.11, `@bitcoinerlab/descriptors` 3.1.7 sets this minimum.
*   **[npm](https://www.npmjs.com/)**: usually comes with Node.js.

```bash title="Install wallet packages"
npm install @tetherto/wdk-wallet-btc @tetherto/wdk-wallet@1.0.0-beta.17
```
