...
| [`@gobob/wdk-protocol-swidge-gateway`](https://www.npmjs.com/package/@gobob/wdk-protocol-swidge-gateway) | BOB Gateway | Native BTC swidge routes to and from tokens on EVM chains and Tron, settled on Bitcoin L1 with no wrapped-BTC intermediary. | [Docs](/sdk/swidge-modules/swidge-gateway/) |
...
| [`@gobob/wdk-protocol-swidge-gateway`](https://github.com/bob-collective/wdk-protocol-swidge-gateway) | Swidge | BOB Gateway native BTC route integration for EVM chains and Tron | [Docs](/sdk/swidge-modules/swidge-gateway/) |
