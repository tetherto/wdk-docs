...
| [`@gobob/wdk-protocol-swidge-gateway`](https://github.com/bob-collective/wdk-protocol-swidge-gateway) | Swidge | BOB Gateway native BTC route integration | [Docs](/sdk/swidge-modules/swidge-gateway/) |
