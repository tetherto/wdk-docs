...
| Module | Route | Ownership | Documentation |
|--------|-------|-----------|---------------|
| [`@tetherto/wdk-protocol-lending-aave-evm`](https://github.com/tetherto/wdk-protocol-lending-aave-evm) | EVM | Tether | [Documentation](/sdk/lending-modules/lending-aave-evm/) |
