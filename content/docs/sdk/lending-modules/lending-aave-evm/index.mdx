...
Works on Aave V3 supported EVM networks (e.g., Ethereum, Arbitrum, Optimism, Polygon, Avalanche, BNB, Celo, Gnosis, Linea, Scroll, Soneium, Sonic, ZkSync, Metis). A working RPC provider and correct token addresses are required.
