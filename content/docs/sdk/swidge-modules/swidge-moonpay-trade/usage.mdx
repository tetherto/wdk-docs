...
[Install the module](#install-the-module), [configure API access](#configure-api-access), [select supported tokens](#select-supported-tokens), and [preview a quote](#preview-a-quote). This accountless flow does not submit a transaction. For support, see [Need Help?](#need-help).
...
Configure an EVM account, confirm the operation, and track settlement.
</Card>
<Card title="Configuration" href="/sdk/swidge-modules/swidge-moonpay-trade/configuration">
Review API access, caching, slippage, and fee limits.
</Card>
