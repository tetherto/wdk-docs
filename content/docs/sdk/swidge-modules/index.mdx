...
|----------------|------------|
| `SwidgeSupportedChain` | `id`, `name`, optional `type`, optional `nativeToken`, optional `providerData` |
| `SwidgeSupportedToken` | `token`, `chain`, `symbol`, `decimals`, optional `address`, optional `name`, optional `providerData` |
| `SwidgeSupportedTokensOptions` | Optional `chain`, `fromChain`, `fromToken`, and `toChain` filters |
