...
|--------|----------|--------|---------------|
| [`wdk-protocol-swidge-orchestra`](https://www.npmjs.com/package/wdk-protocol-swidge-orchestra) ([GitHub](https://github.com/flashnetxyz/wdk-protocol-swidge-orchestra)) | Flashnet Orchestra | BTC and USDT routes returned by Orchestra, including Spark, Bitcoin L1, EVM, Solana, TON, TRON, and destination Lightning routes where supported | [Docs](/sdk/swidge-modules/swidge-orchestra/) |
