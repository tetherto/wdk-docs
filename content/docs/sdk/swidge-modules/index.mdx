...
| Module | Provider | Ownership | Routes | Documentation |
|--------|----------|-----------|--------|---------------|
| [`wdk-protocol-swidge-orchestra`](https://www.npmjs.com/package/wdk-protocol-swidge-orchestra) ([GitHub](https://github.com/flashnetxyz/wdk-protocol-swidge-orchestra)) | Flashnet Orchestra | Community | BTC and stablecoin routes returned by Orchestra. Treat the live [Orchestra route matrix](https://orchestration.flashnet.xyz/v1/orchestration/routes) as provider-level data and filter through runtime discovery before exposing routes. | [Docs](/sdk/swidge-modules/swidge-orchestra/) |
| [`@rhino.fi/wdk-protocol-swidge-rhinofi`](https://www.npmjs.com/package/@rhino.fi/wdk-protocol-swidge-rhinofi) ([GitHub](https://github.com/rhinofi/wdk-protocol-swidge-rhinofi)) | Rhino.fi | Community | Cross-chain swap and bridge routes through the WDK swidge interface. | [Docs](/sdk/swidge-modules/swidge-rhinofi/) |
| [`@tetherto/wdk-protocol-swap-velora-evm`](https://github.com/tetherto/wdk-protocol-swap-velora-evm) | Velora | Tether | Standalone EVM swap routes maintained under the swap module docs while swidge provider coverage expands. | [Docs](/sdk/swap-modules/swap-velora-evm/) |
| [`@tetherto/wdk-protocol-bridge-usdt0-evm`](https://github.com/tetherto/wdk-protocol-bridge-usdt0-evm) | USD₮0 | Tether | Standalone EVM-source bridge routes to EVM and non-EVM destinations maintained under the bridge module docs while swidge provider coverage expands. | [Docs](/sdk/bridge-modules/bridge-usdt0-evm/) |
{/* TODO: Uncomment this in the draft LI.FI docs PR or when it merges. | [`@kenny_io/wdk-protocol-swidge-lifi`](https://www.npmjs.com/package/@kenny_io/wdk-protocol-swidge-lifi) ([GitHub](https://github.com/kenny-io/wdk-lifi-swidge-protocol)) | LI.FI | Community | Swap-only, bridge-only, and combined swap-plus-bridge routes through the WDK swidge interface. | [Package](https://www.npmjs.com/package/@kenny_io/wdk-protocol-swidge-lifi) | */}
