...
EVM token sources need token contract addresses. The package includes common USD₮ source addresses, but production wallets should pass their own allowlist.
