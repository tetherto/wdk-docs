...
<Callout type="info">
Looking for community-built WDK modules you can install and use in your project? Explore the [Building Blocks catalog](https://wdk.tether.io/developers/blocks) on the WDK website.
</Callout>
...
![wdk-starter-browser-extension demo](/assets/wdk-starter-browser-extension.gif)
...
> End-to-end x402 reference implementation on Plasma with USD₮0 and WDK.
...
A complete reference implementation demonstrating the x402 HTTP payment protocol using USD₮0 on the Plasma network. Includes both client and server components, showcasing how WDK wallets can facilitate machine-to-machine payments in a real-world setup.
