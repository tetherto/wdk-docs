...
**What's New**
- **swidge-lifi** ([v0.2.0](https://www.npmjs.com/package/@kenny_io/wdk-protocol-swidge-lifi/v/0.2.0)): Add generated TypeScript declarations, request timeouts and retries, typed LI.FI error classes, input and transaction validation, optional trusted-contract checks, and fee-cap handling for LI.FI swidge routes.
