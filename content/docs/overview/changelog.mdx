...
**What's New**
- **wallet-evm-hinkal** ([v0.0.7](https://www.npmjs.com/package/@hinkal/wdk-wallet-evm-hinkal/v/0.0.7)): Add Hinkal private sends, scheduled-send tracking, and recovery of stuck shielded balances to seed-derived EVM accounts.
