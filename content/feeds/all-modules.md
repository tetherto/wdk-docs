...
| [`@gobob/wdk-protocol-swidge-gateway`](https://www.npmjs.com/package/@gobob/wdk-protocol-swidge-gateway) | BOB Gateway | Community | Native BTC routes to and from tokens on EVM chains and Tron, settled on Bitcoin L1 with no wrapped-BTC intermediary and no custodian | [Docs](/sdk/swidge-modules/swidge-gateway/) |
